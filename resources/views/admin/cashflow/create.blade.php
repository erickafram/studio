            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <select name="category" id="category" required
                        ...
                        <option value="">Selecione</option>
                        <option value="servico" {{ old('category') == 'servico' ? 'selected' : '' }}>Serviço</option>
                        <option value="produto" {{ old('category') == 'produto' ? 'selected' : '' }}>Produto</option>
                        <option value="despesa" {{ old('category') == 'despesa' ? 'selected' : '' }}>Despesa</option>
